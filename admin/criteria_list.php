						...
						<div class="card card-outline card-info">
							...
							<div class="card-footer">
								<div class="d-flex justify-content-end w-100">
									<button class="btn btn-sm btn-primary mx-1" form="manage-criteria">Save</button>
									<button class="btn btn-sm btn-secondary mx-1" form="manage-criteria"
						...
						<div class="callout callout-info">
							...
							if ($qry->num_rows > 0):
								...
								<div class="d-flex justify-content-between w-100">
									...
									<button class="btn btn-sm btn-primary mx-1" form="order-criteria">Save
										Order</button>
								</div>
								<hr>
									...
									<ul class="list-group btn col-md-8" id="ui-sortable-list">
										...
										while ($row = $qry->fetch_assoc()):
											...
											<li class="list-group-item text-left">
												<span class="btn-group drop right float-right">
													<span type="button" class="btn" data-toggle="dropdown" aria-haspopup="true"
														aria-expanded="false">
														<i class="fa fa-ellipsis-v"></i>
													</span>
													<div class="dropdown-menu">
														<a class="dropdown-item edit_criteria text-decoration-none" href="javascript:void(0)"
															data-id="<?php echo $row['id'] ?>">Edit</a>
														<div class="dropdown-divider"></div>
														<a class="dropdown-item delete_criteria text-decoration-none" href="javascript:void(0)"
