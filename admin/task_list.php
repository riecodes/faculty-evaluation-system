	...
	<div class="card card-outline card-success">
		<div class="card-header">
			...
			<div class="card-tools">
				<button class="btn btn-block btn-sm btn-default border-primary" id="new_task"><i class="fa fa-plus"></i> Add New Task</button>
			</div>
			<?php endif; ?>
		</div>
		<div class="card-body">
			<table class="table tab e-hover table-condensed" id="list">
